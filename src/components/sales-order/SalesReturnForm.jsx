            ...
            <div className="p-2 bg-white relative">
                ...
                {loading ? (
                    ...
                    <div className="max-w-6xl mx-auto my-8 p-6 bg-white shadow-md rounded">
                        ...
                        <h1 className="text-center text-2xl font-bold text-blue-700 mb-6 border-b pb-2">
                            Sales Return
                        </h1>
                        ...
                        {showModal && (
                            <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
                                <div className="bg-white w-full max-w-4xl max-h-[80vh] overflow-y-auto p-6 rounded shadow-lg relative">
                                    <button
                        ...
                        <div className="mb-4">
                            ...
                            <select
                                ...
                                className="border p-2 rounded mx-8"
                                required
