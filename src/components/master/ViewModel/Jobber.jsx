...
// import { FaArrowLeft, FaMapMarkerAlt, FaUser, FaIndustry, FaCalendar, FaIdBadge } from "react-icons/fa";
...
//             try {
//                 setLoading(true);
//                 const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/jobber-masters/${id}`, {
//                     headers: {
...
//                     const jobberData = response.data.data;
//                     setJobber({
//                         id: jobberData.documentId,
//                         jobber_id: jobberData.jobber_id,
//                         jobber_name: jobberData.jobber_name,
//                         jobber_plan: jobberData.jobber_plan,
//                         jobber_gstin: jobberData.jobber_gstin,
//                         jobber_address: jobberData.jobber_address,
//                         jobber_code: jobberData.jobber_code,
//                         state_name: jobberData.state,
//                         days: jobberData.days,
//                         work_type: jobberData.work_type,
//                     });
//                 } else {
...
//     if (loading) return <div className="absolute inset-0 flex justify-center items-center bg-opacity-50 bg-gray-200 z-10">
...
//             <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center border-b pb-4">Jobber Details</h2>
...
//                 </div>
//                 <div className="flex items-center gap-3">
//                     <FaCalendar className="text-yellow-500 text-lg" />
//                     <span><strong>Days:</strong> {jobber.days}</span>
//                 </div>
//                 <div className="flex items-center gap-3">
//                     <FaMapMarkerAlt className="text-red-500 text-lg" />
//                     <span><strong>State:</strong> {jobber.state_name}</span>
//                 </div>
//                 <div className="flex items-center gap-3">
//                     <FaIdBadge className="text-indigo-500 text-lg" />
//                     <span><strong>Jobber Code:</strong> {jobber.jobber_code}</span>
//                 </div>
//                 <div className="col-span-2 text-center mt-4 p-4 bg-gray-100 rounded-lg">
//                     <strong>Plan:</strong> {jobber.jobber_plan}
//                 </div>
//             </div>
//         </div>
//     );
...
//     return (
//         <div className="w-4/5 h-[70vh] mx-auto mt-10 p-8 bg-white shadow-2xl rounded-2xl border border-gray-200">
//             {/* Back Button */}
//             <button 
...
//                     <span><strong>Jobber Code:</strong> {jobber.jobber_code}</span>
//                 </div>
//                 <div className="col-span-2 text-center mt-4 p-6 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg shadow-lg">
//                     <strong className="text-lg">Plan:</strong> <span className="text-blue-700 font-semibold">{jobber.jobber_plan}</span>
//                 </div>
//             </div>
//         </div>
//     );
...
//     return (
//         <div className="w-4/5 h-[80vh] mx-auto mt-10 p-8 bg-white shadow-2xl rounded-2xl border border-gray-200">
//             {/* Back Button */}
//             <button
//                 className="flex items-center gap-2 text-blue-600 hover:text-blue-800 transition mb-6"
//                 onClick={() => navigate("/jobber-master")}
...
//                 </div>
//                 <div className="flex items-center gap-3 p-4 bg-gray-100 rounded-lg shadow-md">
//                     <FaFileInvoice className="text-teal-500 text-xl" />
...
//                     <FaFileInvoice className="text-orange-500 text-xl" />
//                     <span><strong>Plan:</strong> {jobber.jobber_plan}</span>
//                 </div>
//             </div>
//         </div>
//     );
