        ...
        <div className="py-2 bg-white rounded-lg relative">
            {loading || load ? (
                ...
                <div>
                    ...
                    {/* Stitching Entry */}
                    {/* Form */}
                    <form className="mb-16 border p-5 border-gray-300 shadow-md rounded-lg" onSubmit={handleSubmit}>
                        <div className="col-span-2 flex border border-blue-500 justify-center my-2 mb-3 rounded p-2">
