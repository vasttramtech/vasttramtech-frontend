...
const TableWithoutSearch = ({ headers, data, onRowClick, loading = false, setLoading }) => {
            ...
            <div className="overflow-x-auto rounded-xl bg-white">
                <div className="max-h-[400px] overflow-y-auto">
                    <table className="w-full border-collapse border border-gray-300">
                        <thead>
                            <tr className="sticky top-0 bg-blue-900 text-white z-10">
                        ...
                        {loading ?
                            (
                                <TableSkeleton rows={filteredData.length} columns={headers.length} />
